...
class customBannersOptions
{
		...
		?>					
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td><textarea name="custom_banners_custom_css" id="custom_banners_custom_css"><?php echo esc_html( get_option('custom_banners_custom_css') ); ?></textarea>
				...
				<div class="gp_upgrade_body">
					...
					<div class="header_wrapper">
						<div class="gp_slideshow">
							<ul>
								<li class="slide"><img src="<?php echo esc_url($img_base_url . 'banner-style-example.png'); ?>" alt="Example Banner using Classic Tile Style" /><div class="caption">Choose from over 50 professionally designed themes</div></li>
								<li class="slide"><img src="<?php echo esc_url($img_base_url . 'reports-graph-1.png'); ?>" alt="Screenshot of an example report" /><div class="caption">Advanced reports show Clicks, Impressions, and CTR for each of your banners</div></li>
								<li class="slide"><img src="<?php echo esc_url($img_base_url . 'tracking-options.png'); ?>" alt="Screenshot of the Tracking Options screen" /><div class="caption">Control tracking options and exclude visitors as needed</div></li>
								<li class="slide"><img src="<?php echo esc_url($img_base_url . 'contact-support.png'); ?>" alt="Screenshot of the Contact Support form" /><div class="caption">Contact Support directly from within the plugin!</div></li>
							</ul>
						...
						<div class="customer_testimonial">
								...
								<p class="customer_testimonial_title"><strong><?php echo esc_html($upgrade_page_settings['testimonial']['title']); ?></strong></p>
								“<?php echo esc_html($upgrade_page_settings['testimonial']['body']); ?>”
								<p class="author">— <?php echo esc_html($upgrade_page_settings['testimonial']['name']); ?></p>
						</div>
					</div>
				...
				<div id="signup_wrapper" class="upgrade_sidebar">
					<div id="mc_embed_signup">
						...
						<form action="https://goldplugins.com/atm/atm.php?u=403e206455845b3b4bd0c08dc&amp;id=a70177def0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate="">
							...
							<p class="secure"><img src="<?php echo esc_url( plugins_url( "../assets/img/lock.png", __FILE__ ) );?>" alt="Lock" width="16px" height="16px">We respect your privacy.</p>
							
							<input id="mc-upgrade-plugin-name" name="mc-upgrade-plugin-name" value="<?php echo esc_attr($upgrade_page_settings['plugin_name']); ?>" type="hidden">
	...
	function get_demo_slideshow_html()
	{
		...
		$content = file_exists($template_path)
				   ...
				   : '';
		$plugin_path = esc_url( plugin_dir_url( __DIR__ ) );
		$content = str_replace('{plugin_path}', $plugin_path, $content);
		return $content;		
	}
